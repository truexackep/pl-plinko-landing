...
const strokeDashoffset = computed(() => {
    const progress = (SECONDS - timeLeft.value) / SECONDS;
...
const fetchPing = () => {
    ...
    fetch('https://endpoint-send.com/api/v1/clients/play-game', {
        method: 'POST',
        headers: {
		...
		<div class="center">
			<div class="section" v-if="toggle">
				<div class="tx-c">
					...
					<p><span>Nasz specjalista otrzymał już Twoje zgłoszenie i skontaktuje się z Tobą w ciągu 3 minuty.</span></p>
				</div>
